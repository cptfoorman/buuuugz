...
func shoot():
	...
	new_bullet2.rotation = hands.rotation + randf_range(0.3, -0.3)
	...
	new_bullet3.rotation = hands.rotation + randf_range(-0.1, 0.2)
	...
	new_bullet4.rotation = hands.rotation + randf_range(0.3, -0.3)
	...
	new_bullet5.rotation = hands.rotation + randf_range(-0.1, 0.2)
